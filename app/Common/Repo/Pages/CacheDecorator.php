...
use Phasty\Service\Cache\CacheInterface;

class CacheDecorator extends AbstractPagesDecorator {

	protected $cache;

	public function __construct(PagesInterface $nextPage, CacheInterface $cache) {
