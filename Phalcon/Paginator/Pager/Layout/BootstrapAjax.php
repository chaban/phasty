...
/**
 * \Phalcon\Paginator\Pager\Layout\BootstrapAjax
 * Pager layout that uses Twitter Bootstrap styles.
 */
class BootstrapAjax extends Layout
{
     ...
     * @var string
     */
    protected $template = '<li><a class="ajaxPager" data-page-number="{%url}" style="cursor: pointer">{%page}</a></li>';
